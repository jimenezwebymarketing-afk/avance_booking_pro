...
/**
 * APPLY_FILTERS: yith_wcbk_admin_calendar_action_bar_reset_filters_url
 *
 * Filters the "reset-filters" URL for the button to be shown in the Calendar action bar on admin side.
 *
 * @param string|false $value The URL or an empty string to not show the button.
 *
 * @return string|false
 */
$reset_filters_url = apply_filters( 'yith_wcbk_admin_calendar_action_bar_reset_filters_url', ! ! $product_id ? remove_query_arg( array( 'product_id' ) ) : false );
...
<form method="get">
	<div id="yith-wcbk-booking-calendar-action-bar">
		<div id="yith-wcbk-booking-calendar-action-bar-left">
			...
			<?php if ( $reset_filters_url ) : ?>
				<a id="yith-plugin-fw__wp-list__reset-filters" class="yith-plugin-fw__button--tertiary" href="<?php echo esc_attr( $reset_filters_url ); ?>"><?php esc_html_e( 'Reset filters', 'yith-booking-for-woocommerce' ); ?></a>
			<?php endif; ?>
		</div>
