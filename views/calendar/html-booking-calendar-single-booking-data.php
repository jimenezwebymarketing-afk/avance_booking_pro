...
<div class="yith-wcbk-booking-calendar-single-booking-data-wrapper">
	...
	<div class="yith-wcbk-booking-calendar-single-booking-data-title__container">
		<div class="yith-wcbk-booking-calendar-single-booking-data-title">
			<?php
			/**
			 * APPLY_FILTERS: yith_wcbk_calendar_single_booking_data_booking_title
			 *
			 ...
			 * @return string
			 */
			echo wp_kses_post( apply_filters( 'yith_wcbk_calendar_single_booking_data_booking_title', $booking->get_formatted_name( $booking_name_format ), $booking ) );
			?>
		</div>
	</div>
