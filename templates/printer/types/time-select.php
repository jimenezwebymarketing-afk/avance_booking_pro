...
$value              = ! empty( $value ) ? $value : '00:00';
$default_time_value = array( '00', '00' );
$time_value         = explode( ':', $value );
if ( 2 !== count( $time_value ) ) {
	$time_value = array( '00', '00' );
	$value      = '00:00';
}
...
/**
 * APPLY_FILTERS: yith_wcbk_time_select_edit_booking_minute_step
 *
 * Filters the minute step for the time-select.
 *
 * @param int $step The step in minutes.
 *
 * @return int
 */
