...
/**
 * APPLY_FILTERS: yith_wcbk_email_booking_details_order_id
 *
 * Filters order id in booking details in emails.
 *
 * @param int               $order_id      The order id.
 * @param YITH_WCBK_Booking $booking       The booking.
 * @param bool              $sent_to_admin True if this is an admin email; false otherwise.
 * @param bool              $plain_text    True if this is a plain email; false otherwise.
